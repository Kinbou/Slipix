...
const Contact = () => (
  <div className="contact">
    ...
    <div className="contact__content">
      ...
      <p>-M'envoyer un Mail à cette adresse : <span>deiizfamilyhd@gmail.com</span> (Seulement pour les propositions professionnelles style partenariat, sponsor etc...)</p>
      <p>-M'envoyer directement un message privé sur Discord en rejoignant la #TEAMSLIP</p>
