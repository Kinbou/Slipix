...
const RoleChampion = () => (
  <div className="roleChampion">
    <div className="roleChampion__breadcrumb">
      <Link to="/">Accueil ></Link>
      <Link to="/guides"> guides > </Link>
      Rôle/Champion
    </div>
    <h1 className="globalTitle-page">Trouver son Rôle/Champion</h1>
    <p>Salut la <span className="red">#TeamSlip</span> c'est coach Slipix et on va parler des <span className="blue">rôles</span> et des <span className="red">champions</span> dans League of Legends</p>
    <img className="roleChampion__logo" src={logoSlipix} alt="" />
    <div className="roleChampion__intro">
      <p className="roleChampion__intro__best">
      ...
      <p>Pour ça il faut se poser les bonnes questions et vous allez voir que
    ...
    <div className="roleChampion__role">
      ...
      <ul>
        ...
        <p className="roleChampion__role__list">Si vous préférez jouer seul dans votre coin, la toplane sera votre paradis en jouant des duellistes ! Pas besoin de se regrouper parfois pour gagner des parties.</p>
        <li><i className="fas fa-arrow-alt-circle-right icon" />J'aime être présent sur la map et être très mobile ?</li>
        <p className="roleChampion__role__list">Si vous aimez avoir une grande présence sur la carte, le rôle de jungle/midlane sera parfait pour vous ! C'est avec le roaming d'un midlaner et l'initiative d'un jungler que les parties sont gagnées.</p>
        <li><i className="fas fa-arrow-alt-circle-right icon" />J'aime farm et last hit les sbires ?</li>
        <p className="roleChampion__role__list">Si vous n'aimez pas le farming de sbires, le rôle de support et de jungle sera optimal. Et si vous aimez ça, le rôle d'ADC sera parfait !</p>
        <li><i className="fas fa-arrow-alt-circle-right icon" />J'aime faire des teamfights ?</li>
        <p className="roleChampion__role__list">Si vous aimez faire des bon gros teamfights, vous pouvez opter pour la toplane en jouant un tank qui va initier le combat, tout comme un jungle tank ou bruiser qui fera la même.</p>
        <li><i className="fas fa-arrow-alt-circle-right icon" />J'aime faire les objectifs ?</li>
        <p className="roleChampion__role__list">Si vous aimez faire les objectifs neutres (Drake, Herald, Nashor) le rôle de jungle est la pour vous ! C'est avec le smite qu'on fait ces objectifs.</p>
        <li><i className="fas fa-arrow-alt-circle-right icon" />J'aime faire des gros dégâts (du DPS) ?</li>
        <p className="roleChampion__role__list">Si vous aimez arroser vos ennemis d'une pluie de dégâts que ça soit du BURST ou du DPS il est temps pour vous de jouer Midlane ou bien ADC.</p>
    ...
    <div className="roleChampion__champion">
      ...
      <ul>
        ...
        <p className="roleChampion__role__list">Si vous aimez vous battre et principalement en duel optez pour les bruisers comme Darius, Jax ou Renekton ainsi que les assassins tels que Zed, Fizz ou Talon !</p>
        <li><i className="fas fa-arrow-alt-circle-right icon" />Mon champion doit être au corps à corps ou à distance ? </li>
        <p className="roleChampion__role__list">Pas vraiment compliqué mais c'est toujours bien de le préciser, ne vous forcez pas à jouer des corps à corps ou des distances si vous n'aimez pas ça.</p>
        <li><i className="fas fa-arrow-alt-circle-right icon" />Mon champion doit être facile ou dur à jouer ? </li>
        <p className="roleChampion__role__list"> Et oui on a pas tous envie de forcément faire des plays ou des montages en jouant du Yasuo, Zed et j'en passe ! Si vous aimez les champions facile ne vous en privez pas, et à l'inverse si vous aimez les combos et les plays lancez-vous !</p>
        <li><i className="fas fa-arrow-alt-circle-right icon" />Mon champion doit être fort en début de partie ou en fin de partie ? </li>
        <p className="roleChampion__role__list">Très important de s'adapter à son champion, si vous aimez jouer relativement safe en début et milieu de partie prenez des champions qui sont redoutables en fin de partie comme Veigar, Vayne, Kayle ou encore Jax ! Pareil pour le contraire si vous aimez mettre du rythme choisissez des champions redoutables en début de partie comme Olaf, Draven, Lee Sin ou bien Qiyana !</p>
